...
** Org Agenda & Capture
   ...
   #+BEGIN_SRC emacs-lisp
     (setq org-todo-keywords
	   '((sequence "TODO(a)" "STARTED(s)" "DONE(d)")))

     (setq org-todo-keyword-faces
	   '(("TODO" . org-warning) ("STARTED" . "green") ("DONE" . (:foreground "green" :weight bold))))
   #+END_SRC
   ...
   #+BEGIN_SRC org
     ** TODO Weekly Status report! <2017-09-29 Fri +1w -3d>
   #+END_SRC
